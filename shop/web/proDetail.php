...
$res=getProById($id);                                                   
//var_dump($res);
$res2=getProsImgById($id);
//var_dump($res2);
if(!($res2 && is_array($res2))){
    alter("图片拿取错误", "proDetal.php");
}
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="#"><?php echo $res['cName']?></a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em><?php echo $res['pSn']?></em>
</div>
	...
	<div class="description clearfix">
		<div class="leftArea">
			<div class="description_imgs">
				<div class="big">
				<a href="../uploads/<?php echo  $res2[0]['albumPath'];?>" class="jqzoom" rel='gal1'  title="triumph" >
					<img width="309px" height="340px" src="../uploads/<?php echo $res2[0]['albumPath']?>" alt="" title="triumph">
					</a>
					<!--  <img src="../uploads/2a133910579ca3b1bf37a9977660bc56.jpg" alt="">  -->
				</div>
				<ul class="des_smimg clearfix" id="thumblist" >
					<?php foreach($res2 as $key=>$proImg):?>
					<li>
					<a  class="<?php echo $key==0?"zoomThumbActive":"";?> active" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '../uploads/<?php echo $proImg['albumPath'];?>',largeimage: '../uploads/<?php echo $proImg['albumPath'];?>'}">
					<img width="54px" height="54px" src="../uploads/<?php echo $proImg['albumPath'];?>" alt="">
					</a>
					</li>
					<?php endforeach;?>
				</ul>
		...
		<div class="rightArea">
			<div class="des_content">
				<h3 class="des_content_tit"><?php echo $res['pName']?></h3>
				<div class="dl clearfix">
					<div class="dt">慕课价</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo $res['iPrice']?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
